    ...
    <Row>
      <Col md="8">
        <h2 data-cy="locationDetailsHeading">
          <Translate contentKey="xcrmApp.location.detail.title">Location</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="city">
              <Translate contentKey="xcrmApp.location.city">City</Translate>
            </span>
          </dt>
          ...
          <dt>
            <Translate contentKey="xcrmApp.location.country">Country</Translate>
          </dt>
